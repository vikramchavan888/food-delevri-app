...
const Texaschicken = () => {
  ...
  return (
    <>
      <div className="texaschiken-nav">
        <img
          className="texaschiken-order-img"
          src="  https://res.cloudinary.com/dlwpgtmcn/image/upload/v1732021307/order_dbajjb.png"
        />

        <div className="texaschiken-nav-links">
          <div className="texaschiken-nav-links-home">Home</div>
          <div className="texaschiken-nav-links-SpecialOffers">
            Special Offers
          </div>
          <div className="texaschiken-nav-links-Restaurants">Restaurants</div>
          <div className="texaschiken-nav-links-TrackOrder">Track Order</div>
          <div className="texaschiken-nav-links-login-signup">
      ...
      <div className="texaschiken-tem-cart">
        <div className="texaschiken-landingpage">
          <div className="texaschiken-deals-options">
            <div className="texaschiken-deals-Chef-Burgers-London">
              <div className="gradient"></div>
              <div className="texaschiken-deals-options-discount">-20%</div>
              <div className="texaschiken-deals-options-add">
                <img
                  className="texaschiken-deals-options-add-img"
              ...
              <img
                className="texaschiken-deals-options-main-img"
                src="https://res.cloudinary.com/dlwpgtmcn/image/upload/v1732368003/Rectangle_8_grurom.png"
              />
            </div>
            <div className="texaschiken-deals-Grand-Ai-Cafe-London">
              <div className="gradient"></div>
              <div className="texaschiken-deals-options-discount">-20%</div>
              <div className="texaschiken-deals-options-add">
                <img
            ...
            <div className="texaschiken-deals-Butterbrot-CafeLondon">
              <div className="gradient"></div>
              <div className="texaschiken-deals-options-discount">-20%</div>
              <div className="texaschiken-deals-options-add">
                <img
