...
const MacD = () => {
 ...
 const filteredGroupedItems = filteredItems.reduce((acc, item) => {
  ...
  return (
    <>
      <div className="macdonal-nav">
        <img
          className="macdonal-order-img"
          src="  https://res.cloudinary.com/dlwpgtmcn/image/upload/v1732021307/order_dbajjb.png"
        />

        <div className="macdonal-nav-links">
          <div className="macdonal-nav-links-home">Home</div>
          <div className="macdonal-nav-links-SpecialOffers">Special Offers</div>
          <div className="macdonal-nav-links-Restaurants">Restaurants</div>
          <div className="macdonal-nav-links-TrackOrder">Track Order</div>
          <div className="macdonal-nav-links-login-signup">
      ...
      <div className="macdonal-tem-cart">
        <div className="macdonal-landingpage">
          <div className="macdonal-deals-options">
            <div className="macdonal-deals-Chef-Burgers-London">
              <div className="gradient"></div>
              <div className="macdonal-deals-options-discount">-20%</div>
              <div className="macdonal-deals-options-add">
                <img
                  className="macdonal-deals-options-add-img"
              ...
              <img
                className="macdonal-deals-options-main-img"
                src="https://res.cloudinary.com/dlwpgtmcn/image/upload/v1732368003/Rectangle_8_grurom.png"
              />
            </div>
            <div className="macdonal-deals-Grand-Ai-Cafe-London">
              <div className="gradient"></div>
              <div className="macdonal-deals-options-discount">-20%</div>
              <div className="macdonal-deals-options-add">
                <img
            ...
            <div className="macdonal-deals-Butterbrot-CafeLondon">
              <div className="gradient"></div>
              <div className="macdonal-deals-options-discount">-20%</div>
              <div className="macdonal-deals-options-add">
                <img
